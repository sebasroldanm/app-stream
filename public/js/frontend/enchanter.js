if (typeof window.Enchanter === "undefined") {
    window.Enchanter = class Enchanter {
        ...
        getIndex(element) {
            return (
                [...element.parentNode.children].findIndex(
                    (c) => c == element,
                ) + 1
            );
        }
        currentIndex() {
            return this.getIndex(
                this.container.querySelector(".nav .nav-link.active"),
            );
        }
        nextIndex() {
