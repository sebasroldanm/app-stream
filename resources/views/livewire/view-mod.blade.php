                ...
                <div class="card">
                    <div class="card-body profile-page p-0">
                        <div class="profile-header">
                            <div style="height: 300px; overflow: hidden;" class="position-relative">
                                @if ($intro->type ==  'image')
                                    <img style="width: 100%; height: 100%; object-fit: cover; object-position: center;"
                                    src="{{ $intro->url }}" alt="profile-bg" class="rounded img-fluid">
                                @else
                                    <video autoplay loop muted style="width: 100%; height: 100%; object-fit: cover; object-position: center;">
                                ...
                                <ul class="header-nav list-inline d-flex flex-wrap justify-end p-0 m-0">
                                    @if ($data_mod->isError)
                                        <li><a href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Username no válido">
                                            <i class="ri-alert-line"></i>
                                        </a></li>
                                    @else
                                        <li><a wire:click="updateDataMod" href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Actualizar">
                                            <i class="ri-refresh-line"></i>
                                        </a></li>
                                    @endif
                                    @if (isset($data_mod->data->user->modelTopPosition) && $data_mod->data->user->modelTopPosition->position !== 0)
                                        <li><a href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Posición: {{ $data_mod->data->user->modelTopPosition->position }}">
                                            <i class="las la-trophy"></i>
                                        </a></li>
                                        @else
                                            @if(isset($data_mod->data->usercurrPosition)  && $data_mod->data->usercurrPosition !== 0)
                                                <li><a href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Posición: {{ $data_mod->data->user->modelTopPosition->position }}">
                                                    <i class="las la-trophy"></i>
                                                </a></li>
                                            @endif
                            ...
                            <div
                                ...
                                <div class="social-links">
                                    <ul
                                        ...
                                        @if ($data_mod->data)
                                            @isset ($data_mod->data->user->socialLinksData)
                                                @isset ($data_mod->data->user->socialLinksData->twitter)
                                                    <li class="text-center pe-3">
                                                        <a href="{{ $data_mod->data->user->socialLinksData->twitter->link }}" target="_blank">
                                                            <img src="{{ asset('/images/icon/09.png') }}"
                                                                class="img-fluid rounded" alt="Twitter"></a>
                                                    </li>
                                                @endisset
                                                @isset ($data_mod->data->user->socialLinksData->instagram)
                                                    <li class="text-center pe-3">
                                                        <a href="{{ $data_mod->data->user->socialLinksData->instagram->link }}" target="_blank">
                                    ...
                                    @if ($data_mod->data)
                                        <ul
                                            ...
                                            <li class="text-center ps-3">
                                                <h6>Fotos</h6>
                                                <p class="mb-0">{{ $data_mod->data->user->photosCount }}</p>
                                            </li>
                                            <li class="text-center ps-3">
                                                <h6>Videos</h6>
                                                <p class="mb-0">{{ $data_mod->data->user->videosCount }}</p>
                                            </li>
                                            <li class="text-center ps-3">
                                                <h6>Favoritos</h6>
                                                <p class="mb-0">{{ $data_mod->data->user->user->favoritedCount }}</p>
                                            </li>
                                        </ul>
                                    @endif
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="event-post position-relative">
                                                        <a href="#"><img
                                                                src="{{ asset('/images/page-img/07.jpg') }}"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="event-post position-relative">
                                                        <a href="#"><img
                                                                src="{{ asset('/images/page-img/06.jpg') }}"
                                                                alt="gallary-image" class="img-fluid rounded"></a>
                                                        <div class="job-icon-position">
                                                            <div
                                                                class="job-icon bg-primary p-2 d-inline-block rounded-circle">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <ul class="profile-img-gallary p-0 m-0 list-unstyled">
                                                <li class=""><a href="#"><img
                                                            src="{{ asset('/images/page-img/g1.jpg') }}"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class=""><a href="#"><img
                                                            src="{{ asset('/images/page-img/g2.jpg') }}"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class=""><a href="#"><img
                                                            src="{{ asset('/images/page-img/g3.jpg') }}"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class=""><a href="#"><img
                                                            src="{{ asset('/images/page-img/g4.jpg') }}"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class=""><a href="#"><img
                                                            src="{{ asset('/images/page-img/g5.jpg') }}"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class=""><a href="#"><img
                                                            src="{{ asset('/images/page-img/g6.jpg') }}"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class=""><a href="#"><img
                                                            src="{{ asset('/images/page-img/g7.jpg') }}"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class=""><a href="#"><img
                                                            src="{{ asset('/images/page-img/g8.jpg') }}"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                                <li class=""><a href="#"><img
                                                            src="{{ asset('/images/page-img/g9.jpg') }}"
                                                            alt="gallary-image" class="img-fluid" /></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <ul
                                                            ...
                                                            <li class="col-md-6 mb-3">
                                                                <div class="bg-soft-primary rounded p-2 pointer me-3">
                                                                    <a href="#"></a><img
                                                                        src="{{ asset('/images/small/12.png') }}"
                                                                        alt="icon" class="img-fluid"> Gif</div>
                                                            </li>
                                                            <li class="col-md-6 mb-3">
                                                                <div class="bg-soft-primary rounded p-2 pointer me-3">
                                                                    <a href="#"></a><img
                                                                        src="{{ asset('/images/small/13.png') }}"
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="post-item">
                                                ...
                                                <div class="user-post">
                                                    <a href="#"><img
                                                            src="{{ asset('/images/page-img/p1.jpg') }}"
                                            ...
                                            <div class="post-item">
                                                ...
                                                <div class="user-post">
                                                    <a href="#"><img
                                                            src="{{ asset('/images/page-img/p3.jpg') }}"
                                                            alt="post-image" class="img-fluid w-100" /></a>
                                                </div>
                                                <div class="comment-area mt-3">
                                                    <div
                                        ...
                                        <ul class="nav nav-pills basic-info-items list-inline d-block p-0 m-0">
                                            ...
                                            <li>
                                                <a class="nav-link" href="#v-pills-lived-tab"
                                                    data-bs-toggle="pill" data-bs-target="#v-pills-lived-tab"
